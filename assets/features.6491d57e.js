import{_ as te}from"./DemoLinks.09b4b6cb.js";import{_ as w,a as se}from"./DemoTitle.63799a9a.js";import{D as oe}from"./DocumentationFooter.3fc21694.js";import{_ as $,a as I}from"./PrismCode.424bb1bc.js";import{_ as D}from"./DemoProps.vue_vue_type_script_setup_true_lang.6fb7fa21.js";import{b as v,o as c,e as p,f as e,w as t,u as a,b$ as q,F as h,j as o,l as k,E as L,G as S,co as P,cp as ae,g as y,r as W,m as z,n as g,k as F,t as b,h as H,i as C,ap as Z,q as E,x as Q,y as X,A as R,C as T,bZ as A,cq as G,cl as V,cm as j,cr as K,cs as M,ct as U,cu as O}from"./index.4498c4e2.js";import{_ as ie}from"./FeatureBlockA.03bb8016.js";import{_ as J}from"./IconBox.39e8ec7c.js";import{_ as le}from"./FeatureBlockL.69cbad4d.js";import"./vue-scrollto.3478456d.js";import"./_commonjsHelpers.712cc82f.js";import"./vue.runtime.esm-bundler.5e5a08c0.js";import"./SimpleTableHeader.2e6cfa8e.js";const ne={props:[{name:"alignment",type:"string",required:"false",default:"undefined",values:["centered"]},{name:"features",type:"array",required:"true",default:"( ) => [ ]",values:["see sample tab for an example data structure"]},{name:"columns",type:"number",required:"false",default:"4",values:["3","4","6"]},{name:"limit",type:"number",required:"false",default:"6",values:["number"]},{name:"size",type:"string",required:"false",default:"undefined",values:["small","medium"]},{name:"rounded",type:"boolean",required:"false",default:"false",values:["boolean"]},{name:"links",type:"boolean",required:"false",default:"false",values:["boolean"]},{name:"inverted",type:"boolean",required:"false",default:"false",values:["boolean"]}],slots:[]},re=`
...
`,os=o("div",{class:"py-4"},null,-1),as=o("p",{class:"paragraph rem-95"},[k(" Vulk ships with highly customizable and versatile Feature blocks that you can use in any page. Each block comes with it's own styles and props. Use the props to build your own examples or use one of the prebuilt examples. Every block is natively supporting dark mode. However, there are some cases when even in light mode, the section background is dark or colored. In that case, you can use the "),o("code",null,"inverted"),k(" prop to invert the component when in light mode. See markup and props tab for more details about usage. ")],-1),is=v({__name:"FeatureBlockIDoc",setup(f){return(s,_)=>{const i=w,r=Yt,l=L,n=S,u=$,d=D,m=I;return c(),p(h,null,[e(n,{id:"block-i-demo","bordered-bottom":""},{default:t(()=>[e(l,null,{default:t(()=>[e(i,{title:"Block I",subtitle:"Feature block I variation 1",link:"block-i-props"}),e(r,{title:"Amazing Features",content:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Illi enim
        inter se dissentiunt. Expectoque quid ad id, quod quaerebam,
        respondeas. Nescio quo modo praetervolavit oratio. Duo Reges:
